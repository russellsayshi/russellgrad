...
if __name__ == "__main__":
    ...
    # RussellGrad version
    tokenizer = Tokenizer(vocab_size, max_seq_len, word_embedding_dim, pad_token_id)
    test_strings = ["hello", "world", "ai"]
    
    output_tok, _, padding_mask_tok = tokenizer.forward(test_strings)
    ...
    # RussellGrad version
    transformer_tokenizer = Tokenizer(vocab_size, max_seq_len, word_embedding_dim, pad_token_id)
